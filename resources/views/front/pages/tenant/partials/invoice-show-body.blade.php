        ...
        @if ($isAdminOrg)
            <div class="crm-page-header mb-4">
                ...
                <div class="crm-page-actions">
                    ...
                    <a href="{{ org_route('billing.invoice.pdf', $invoice->id) }}" class="btn btn-crm-primary btn-sm">Download PDF</a>
        ...
        @else
            <div class="mb-4 d-flex justify-content-between align-items-start flex-wrap gap-2">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ org_route('billing.invoice.pdf', $invoice->id) }}" class="btn btn-primary btn-sm">Download PDF</a>
                    <button type="button" class="btn btn-outline-secondary btn-sm" onclick="window.print()">Print</button>
                </div>
            </div>
        @endif
