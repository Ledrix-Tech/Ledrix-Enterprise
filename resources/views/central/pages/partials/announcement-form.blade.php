...
<div class="row">
    <div class="col-md-4 mb-3">
        ...
        <select name="type" class="form-select" required>
            @foreach (['info', 'warning', 'success', 'danger', 'maintenance'] as $type)
...
<div class="form-check">
    <input class="form-check-input" type="checkbox" name="blocks_crm" value="1" id="blocks_crm_{{ $a->id ?? 'new' }}"
        @checked(old('blocks_crm', $a->blocks_crm ?? false))>
    <label class="form-check-label" for="blocks_crm_{{ $a->id ?? 'new' }}">
        Block Admin &amp; Seller CRM (503 maintenance page; not dismissible)
    </label>
</div>
