                        ...
                        @forelse ($announcements as $announcement)
                            <tr>
                                ...
                                <td data-label="Title">
                                    ...
                                    <td data-label="Type"><span class="badge bg-{{ $announcement->type === 'danger' ? 'danger' : ($announcement->type === 'warning' || $announcement->type === 'maintenance' ? 'warning text-dark' : ($announcement->type === 'success' ? 'success' : 'info')) }}">{{ $announcement->type }}</span></td>
                                ...
                                <td data-label="Window">
                                    ...
                                    @endif
                                    @if ($announcement->blocks_crm)
                                        <br><small class="text-danger">Blocks CRM</small>
                                    @endif
                                </td>
