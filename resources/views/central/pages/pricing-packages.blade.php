                ...
                <div class="sa-card sa-package-card">
                    <div class="sa-card-header">
                        ...
                        @if ((int) $package->trial_days > 0)
                            <span class="badge bg-info text-dark">{{ (int) $package->trial_days }}-day trial</span>
                        @else
                        ...
                        <form method="POST" action="{{ route('super-admin.pricing-packages.update', $package->id) }}">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="form-text">0 = no trial; tenant must pay after signup. Applies to new signups only.</div>
                                </div>
                                <div class="col-md-4 mb-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('super-admin.pricing-packages.post') }}" id="addPackageForm">
                        ...
                        <hr>
                        <h5 class="mb-3">Trial &amp; display</h5>
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Free trial (days)</label>
                                <input type="number" name="trial_days" class="form-control" min="0" max="365" value="14">
                                <div class="form-text">0 = no trial. Basic often 7, Standard 14, Premium 30.</div>
                            </div>
                        </div>
