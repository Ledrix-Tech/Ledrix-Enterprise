...
@section('central-content')
    ...
    <div class="sa-stats">
        <div class="sa-stat">
            ...
            <div class="sa-stat-label">MRR ({{ $subscriptionMetrics['base_currency'] ?? $subscriptionMetrics['primary_currency'] }})</div>
            <div class="sa-stat-value">{{ number_format($subscriptionMetrics['mrr'], 2) }}</div>
            <div class="sa-stat-meta">{{ $subscriptionMetrics['active_paid'] }} paid active · FX-normalized</div>
        </div>
        <div class="sa-stat">
            <div class="sa-stat-icon"><i class="bi bi-bar-chart-line"></i></div>
            <div class="sa-stat-label">ARR ({{ $subscriptionMetrics['base_currency'] ?? $subscriptionMetrics['primary_currency'] }})</div>
            <div class="sa-stat-value">{{ number_format($subscriptionMetrics['arr'], 2) }}</div>
            <div class="sa-stat-meta">MRR × 12</div>
        </div>
        <div class="sa-stat">
            <div class="sa-stat-icon"><i class="bi bi-arrow-down-right"></i></div>
            <div class="sa-stat-label">Churn (30d)</div>
            <div class="sa-stat-value">{{ number_format($subscriptionMetrics['churn_rate_30d'], 1) }}%</div>
            <div class="sa-stat-meta">{{ $subscriptionMetrics['churned_30d'] }} cancelled/expired</div>
        </div>
