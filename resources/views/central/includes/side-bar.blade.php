...
<aside class="sa-sidebar" id="saSidebar">
    <ul class="sa-nav">
        ...
        @if ($isAdmin)
            ...
            <li>
                <a class="sa-nav-link {{ str_starts_with((string) $route, 'super-admin.fx-rates') ? 'active' : '' }}"
                    href="{{ route('super-admin.fx-rates.get') }}">
                    <i class="bi bi-currency-exchange"></i>
                    <span>FX Rates</span>
                </a>
            </li>
            <li>
                <a class="sa-nav-link {{ str_starts_with((string) $route, 'super-admin.theme') ? 'active' : '' }}"
                    href="{{ route('super-admin.theme.get') }}">
                    <i class="bi bi-palette"></i>
                    <span>Website Theme</span>
                </a>
            </li>
            <li>
                <a class="sa-nav-link {{ str_starts_with((string) $route, 'super-admin.sso-settings') ? 'active' : '' }}"
                    href="{{ route('super-admin.sso-settings.get') }}">
        ...
        <li>
            ...
            <li>
                <a class="sa-nav-link {{ str_starts_with((string) $route, 'super-admin.status') ? 'active' : '' }}"
                    href="{{ route('super-admin.status.get') }}">
