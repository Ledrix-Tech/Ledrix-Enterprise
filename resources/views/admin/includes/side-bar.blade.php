    ...
    <ul class="crm-nav">
        ...
        @else
            ...
            @if (isProjectManager())
                ...
                <li>
                    <a class="crm-nav-link {{ str_starts_with($route, 'admin.projects.') ? 'active' : '' }}"
            ...
            @else
                ...
                @if (isAdmin())
                    ...
                    <li>
                        <a class="crm-nav-link {{ str_starts_with($route, 'admin.org.webhooks') ? 'active' : '' }}"
                            href="{{ route('admin.org.webhooks') }}">
