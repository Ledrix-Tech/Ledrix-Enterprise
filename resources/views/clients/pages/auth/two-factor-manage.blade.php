...
@section('auth-content')
    <div class="crm-auth-page">
        <div class="crm-auth-card" style="max-width: 420px;">
            ...
            <p class="crm-auth-sub">2FA is enabled on your client portal account.</p>
            ...
            <form method="POST" action="{{ route('client.2fa.disable') }}">
                @csrf
            ...
            <a href="{{ route('client.profile.get') }}" class="d-inline-block mt-3 small">Back to profile</a>
        </div>
    </div>
@endsection
