...
if (! function_exists('org_route')) {
    ...
    function org_route(string $name, mixed $parameters = [], bool $absolute = true): string
    {
        ...
        $map = [
            ...
            'webhooks' => 'admin.org.webhooks',
            'webhooks.store' => 'admin.org.webhooks.store',
            'webhooks.toggle' => 'admin.org.webhooks.toggle',
            'webhooks.destroy' => 'admin.org.webhooks.destroy',
            ...
            'billing.stripe.portal' => $admin ? 'admin.org.billing.stripe.portal' : 'tenant.billing.stripe.portal',
            ...
            'billing.invoice.pdf' => $admin ? 'admin.org.billing.invoice.pdf' : 'tenant.billing.invoice.pdf',
            'plan.change' => $admin ? 'admin.org.plan.change' : 'tenant.plan.change',
