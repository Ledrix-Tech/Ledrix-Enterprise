...
{
    public const PROVIDERS = ['stripe', 'meezan'];

    private const CACHE_KEY = 'platform_billing_settings.v3';
    ...
    public function definitions(): array
    {
        return [
            'stripe' => [
                'label'  => 'Stripe',
                'help'   => 'Card payments for international (USD) tenant subscriptions. Enable to show Stripe checkout on the billing page.',
                'fields' => [
            ...
            'meezan' => [
                ...
                'help'   => 'PKR bank transfer + Raast QR for Pakistani subscriptions. Super-admin confirms pending payments.',
                'fields' => [
