...
class RegisterTenantService
{
    ...
    public function register(array $data): array
    {
        ...
        try {
            ...
            $trial = app(\App\Services\Billing\PackageTrialResolver::class)->resolve($package);
            ...
            TenantMembership::create([
                ...
                'status'       => $trial['membership_status'],
                'renewed_by'   => 'tenant',
            ...
            AuditLog::record(
                ...
                context: [
                    ...
                    'description'  => $trialDays > 0
                        ? "Registered on {$package->name} plan with {$trialDays}-day trial."
                        : "Registered on {$package->name} plan (no trial — payment required).",
                    'after'        => [
