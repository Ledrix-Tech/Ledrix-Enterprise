...
Route::middleware('tenant')->group(function () {
    ...
    Route::get('/tenant-profile/plan', [OrganizationPlanController::class, 'index'])
        ->name('tenant.plan');
    Route::post('/tenant-profile/plan/change', [OrganizationPlanController::class, 'change'])
        ->name('tenant.plan.change');
    ...
    Route::get('/tenant-profile/billing/invoices/{invoice}', [\App\Http\Controllers\Tenant\TenantInvoiceController::class, 'show'])
        ...
        ->whereNumber('invoice');
    Route::get('/tenant-profile/billing/invoices/{invoice}/pdf', [\App\Http\Controllers\Tenant\TenantInvoiceController::class, 'downloadPdf'])
        ->name('tenant.billing.invoice.pdf')
        ->whereNumber('invoice');
    ...
    Route::post('/tenant-profile/billing/stripe/portal', [StripeBillingController::class, 'portal'])
        ->name('tenant.billing.stripe.portal');
