...
return [
    ...
    */
    ...
    /*
    | SaaS subscription invoice tax (F-06). Rate 0 keeps current behavior.
    | Applied in CreateSubscriptionInvoiceService after referral adjustments.
    */
    'invoice_tax' => [
        'rate'  => (float) env('INVOICE_TAX_RATE', 0),
